...
Instead of implementing a cluster, think about your or your organisation's needs for GeoServer, and whether you need to implement clustering now or in the future.
Why, or why not?
If you don't need clustering now, try to think of potential scenarios where you would need to scale out your GS implementation with clustering.
