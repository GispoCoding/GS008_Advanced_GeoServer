...
Next, pick a new [GeoServer SLD extension](https://docs.geoserver.org/master/en/user/styling/sld/extensions/index.html) you haven't used before and see it in action.
Think about the potential use cases for the extension, but also try to assess potential issues with rendering performance and compatibility with other software.
